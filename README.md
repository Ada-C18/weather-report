To-Do
 ...
 Show default temp
 Add emojis up and down arrows-ms
 Finish wave 4

 button (Register and addEventListener to Get Realtime Temperature button) - Milena
 get API functions working and button get temp - together office hours
 Wave 5 - Milena

 set up dropdown select element in HTML file
 ...
 Commit changes made during office hours
...
- When we have to work outside of class, we will do it online max till 8/9pm. 
- We both have same bus schedules, so after we both go home we can probably work.
- Not work on any code without discussing or communicating since this is a pair project. 

### Your learning style
- Puja: processing 1st and then writing. Visual learner. 
...
- Puja: prefers feedback on face. 
- Milena: 1st choice is talk in person and follow up if questions. Ask before giving feedback and timing. Tell it as soon as it happens. 
