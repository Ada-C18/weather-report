...
const windowLoad = () => {
  ...
  // Yun: With JS, if we define (let xx =) these variables here inside this function windowLoad,
  // we cannot use them in other functions. Something we need to reconsider.
  // On my browser, it's giving me an error saying "xx is not defined" on line 121, line 126,
  // if they are not global variables.
